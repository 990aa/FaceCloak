"""Runtime diagnostics for local and Hugging Face Space environments."""
...
from visioncloak.models import load_surrogate_bundle
from visioncloak.project import TORCH_CACHE_DIR
...
def collect_runtime_report() -> RuntimeReport:
    ...
    try:
        load_surrogate_bundle("clip_l14")
    ...
    return RuntimeReport(
        ...
        status=status,
        notes="CPU execution is the intended default target for VisionCloak.",
    )
