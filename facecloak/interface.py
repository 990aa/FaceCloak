...
[Read full evaluator validation details in the README](https://huggingface.co/spaces/a-01a/facecloak/blob/main/README.md#evaluator-validation-black-box-transferability-against-state-of-the-art-oracles)
""",
            elem_classes=["panel"],
        )
